package com.ne.microservice.web.rest.errors;

import com.ne.microservice.NemicroserviceApp;
import com.ne.microservice.config.SecurityBeanOverrideConfiguration;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, NemicroserviceApp.class})
